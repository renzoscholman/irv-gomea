...
fitness_t *fitness_t::getFitnessClass(int problem_index, int number_of_parameters, double vtr) {
    if (problem_index > 100000) {
        ...
        // printf("Instantiating SoREB with parameters: %d, vtr: %f, cond 1: %f, cond 2: %f, rot 1: %f, rot 2: %f, overlap: %d, block: %d\n", number_of_parameters, vtr, conditioning_number_1, conditioning_number_2, rotation_angle_1, rotation_angle_2, overlap_size, block_size);
