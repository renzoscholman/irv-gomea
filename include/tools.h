...
// Fixes issues with VS code not understanding whats going on
#if not defined(EIGEN) and not defined(ARMADILLO)
#define ARMADILLO
#endif
...
extern double alpha_ams[3];
extern double alpha_cov[3];
