...
BASE_DIR = "data/scalability-bisection-incremental-"
...
PROBLEM_DIMENSIONS = [
    ...
    ("reb5-disjoint-pairs", [9, 18, 36, 72]),
    ("reb-grid", [16, 36, 64, 81]),
    ("reb10-no-overlap", [10, 20, 40, 80]),
    ("reb10-small-overlap", [10, 19, 37, 82]),
    ("reb10-small-overlap-alternating", [10, 19, 37, 82]),
    ("reb10-large-overlap", [10, 22, 40, 82]),
]
...
def main():
    ...
    result_population_size, result_median_num_evaluations, result_corrected_num_evaluations = run_bisection(
        ...
        base_run_config, DEFAULT_NUM_REPEATS_PER_BISECTION_TEST, bisection_repeat=repeat, incremental=True, log_progress=True
    )
